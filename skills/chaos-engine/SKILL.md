...
# Chaos Engine — Controlled Demolition for Living Prose
...
- "She thought about calling someone but there was nobody to call, so she didn't."
...
## Devoted Reader Protection (SFF and Literary Fiction Only)
...
- **Precision Deflation:** Do NOT deflate numbers that serve world-building or that the Devoted Reader would care about (spice quantities, dates of historical events, distances in space). Only deflate numbers that serve the pipeline's desire to seem concrete.
